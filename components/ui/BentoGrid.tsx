...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 5%, rgba(255,230,0,1) 99%, rgba(0,0,0,1) 100%)",
      }}
    >
      <div className={`${id === 6 ? "flex justify-center" : ""} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-50 flex items-center justify-center text-black-100 font-bold" />
          </BackgroundGradientAnimation>
        )}
